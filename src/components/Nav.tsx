    ...
    <div>
      <nav className="flex flex-row justify-between mt-2 min-h-12 mx-7 ">
        <div className="flex justify-start items-center w-1/2 pl-4">
          <h1 className="sm:text-2xl md:text-3xl xl:text-5xl font-bold text-black">
            Ever Poo Games
          </h1>
        </div>
        <div className="flex flex-row justify-between  items-center bg-black text-white w-1/2 rounded-lg border border-yellow-500">
          ...
          <div
            className={`${
              menuOpen
                ? "absolute flex flex-col w-64 top-12 z-50  border border-yellow-500"
                : "hidden"
            } xl:flex xl:flex-row justify-between items-center bg-black text-white w-full xl:w-auto rounded-lg mt-2 xl:mt-0`}
          >
            <div className="ml-4 flex flex-col xl:flex-row  items-center ">
              <Link
                className="min-h-12 flex justify-center items-center hover:bg-yellow-500 hover:text-black cursor-pointer xl:pr-6"
                href="/"
              >
                <h3>HOME</h3>
              </Link>
